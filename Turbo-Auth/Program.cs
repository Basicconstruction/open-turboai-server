...
// builder.Services.AddScoped<IImageHandler, OpenAiImageHandler>();
// builder.Services.AddScoped<IImageHandler, NovitaImageHandler>();
...
builder.WebHost.UseUrls($"http://0.0.0.0:{11000}");
// builder.WebHost.UseUrls($"http://0.0.0.0:{11000}","https://localhost:44301");
